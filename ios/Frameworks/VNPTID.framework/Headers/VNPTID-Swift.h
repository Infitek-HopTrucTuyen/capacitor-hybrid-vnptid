...
#ifndef VNPTID_SWIFT_H
#define VNPTID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VNPTID",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@protocol VnptIdDelegate;
@class NSString;

SWIFT_CLASS("_TtC6VNPTID14ManangerVnptId")
@interface ManangerVnptId : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ManangerVnptId * _Nonnull shareIns;)
+ (ManangerVnptId * _Nonnull)shareIns SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) id <VnptIdDelegate> _Nullable delegate;
@property (nonatomic, copy) NSString * _Nonnull AUTHOR_USER_RESULT;
@property (nonatomic) BOOL RELOGIN;
@property (nonatomic) BOOL GET_USER_INFO;
@property (nonatomic) BOOL IS_HIDDEN_BACK_LOGIN;
@property (nonatomic) BOOL GET_ID_TOKEN;
@property (nonatomic) BOOL GET_ACCESS_TOKEN;
@property (nonatomic) BOOL GET_REFRESH_TOKEN;
@property (nonatomic) BOOL GOTO_SDK_USER_PROFILE;
@property (nonatomic, copy) NSString * _Nonnull CLIENT_INFO;
@property (nonatomic, copy) NSString * _Nonnull REFRESH_TOKEN_SUPER;
@property (nonatomic, copy) NSString * _Nonnull ID_TOKEN_SUPER;
@property (nonatomic, copy) NSString * _Nonnull COOKIE_OTP;
@property (nonatomic, copy) NSString * _Nonnull GOTO_AUTHEN_METHOD;
@property (nonatomic, copy) NSString * _Nonnull GOTO_MAPPING_ACCOUNT;
- (void)logOut;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6VNPTID13VNPTIDOTPView")
@interface VNPTIDOTPView : UIView
...
@interface VNPTIDOTPView (SWIFT_EXTENSION(VNPTID)) <UITextFieldDelegate>
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP6VNPTID14VnptIdDelegate_")
@protocol VnptIdDelegate
- (void)callBackUserInfoDelegate:(NSString * _Nonnull)INFOR_USER_RESULT;
- (void)callBackIdTokenDelegate:(NSString * _Nonnull)ID_TOKEN;
- (void)callBackAccessTokenDelegate:(NSString * _Nonnull)ACSSESS_TOKEN;
- (void)callBackRefreshTokenDelegate:(NSString * _Nonnull)GET_REFRESH_TOKEN_RESULT;
- (void)callBackOtpDelegate:(NSString * _Nonnull)OPT;
- (void)callBackMappingAccountWith_INFO_MAPPING:(NSString * _Nonnull)_INFO_MAPPING;
- (void)callBackWhenLogoutWith_LOGOUT_SUCCESS:(BOOL)_LOGOUT_SUCCESS;
@optional
- (void)dissmissSDKWith_DISMISS:(BOOL)_DISMISS;
@end

@class UIViewController;
@class NSBundle;

SWIFT_CLASS("_TtC6VNPTID12VnptIdNaviVc")
@interface VnptIdNaviVc : UINavigationController
- (void)viewDidLoad;
...
@interface VnptIdNaviVc (SWIFT_EXTENSION(VNPTID))
+ (VnptIdNaviVc * _Nonnull)naviController SWIFT_WARN_UNUSED_RESULT;
@end
